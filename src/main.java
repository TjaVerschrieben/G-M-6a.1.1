...
public class main {
    public static void main(String[] args){
        ...
        System.out.println("Zeiten mit Arraylist und LinkedList: ");

        long start = System.nanoTime();
        ListTester.addEnd(meineListe, 10);
        ...
        start = System.nanoTime();
        ListTester.addFirst(meineListe, 200);
        end = System.nanoTime();
        System.out.println("ArrayList: " + (end-start)/1000);

        start = System.nanoTime();
        ListTester.addFirst(meineListe2, 200);
        end = System.nanoTime();
        System.out.println("LinkedList: " + (end-start)/1000);
